            ...
            <table border="1" cellspacing="0" cellpadding="8" style="width: 100%; text-align: center;">
                ...
                <?php foreach ($myTournaments as $t): ?>
                    <tr>
                        ...
                        <td><?php echo ($t['status'] == 'Upcoming') ? '<span style="color: blue;">Upcoming</span>' : (($t['status'] == 'Ongoing') ? '<span style="color: green;">Ongoing</span>' : '<span style="color: red;">Completed</span>'); ?>
                        </td>
            ...
            <table border="1" cellspacing="0" cellpadding="8" style="width: 100%; text-align: center;">
                ...
                <?php foreach ($myMatches as $m): ?>
                    <tr>
                        ...
                        <td><?php echo $m['tournament_title']; ?></td>
                        <td>
                            <?php
                        ...
                        <td style="font-weight: bold; color: green;">
                            <?php echo $m['winner_name'] ? $m['winner_name'] : "TBD"; ?></td>
                    </tr>
                <?php endforeach; ?>
            </table>
        <?php else: ?>
