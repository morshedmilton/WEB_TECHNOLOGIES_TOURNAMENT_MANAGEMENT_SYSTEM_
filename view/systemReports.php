...
// ১. সিকিউরিটি চেক: শুধুমাত্র অ্যাডমিন অ্যাক্সেস করতে পারবে
...
<head>
    ...
    <style>
        /* প্রিন্ট করার সময় বাটন এবং লিঙ্ক লুকানোর জন্য CSS */
        @media print {
            .no-print { display: none; }
            fieldset { border: none; margin: 0; width: 100%; }
...
<body>
    <fieldset style="width: 850px; margin: 30px auto;">
        ...
        <div class="no-print" style="text-align: center; margin-bottom: 20px;">
            ...
            <button onclick="window.print()" style="cursor: pointer; padding: 5px 10px; background: #0066cc; color: white; border: none; border-radius: 3px;">🖨️ Print / Save PDF</button>
        </div>
        <hr class="no-print">
        ...
        <div style="text-align: center;">
            ...
            <p><strong>Generated By:</strong> <?php echo $_SESSION['username']; ?> | <strong>Date:</strong> <?php echo $date; ?></p>
        </div>
        ...
        <table border="1" cellspacing="0" cellpadding="8" style="width: 100%; text-align: center;">
            ...
            <?php foreach ($tournaments as $t): ?>
                <tr>
                    ...
                    <td>
                        <?php 
                            if($t['status'] == 'Upcoming') echo '<span style="color: blue;">Upcoming</span>';
                            elseif($t['status'] == 'Ongoing') echo '<span style="color: green;">Ongoing</span>';
                            else echo '<span style="color: red;">Completed</span>';
                        ?>
                    </td>
