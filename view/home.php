...
$role = isset($_SESSION['role']) ? $_SESSION['role'] : 'Organizer';
?>
...
<body>
    <fieldset style="width: 850px; margin: 30px auto;">
            ...
            <?php if ($role == 'Admin') { ?>
                <div style="width: 48%; border-left: 1px solid #ccc; padding-left: 20px;">
                    ...
                    <ul>
                        ...
                        <li><a href="systemReports.php" style="text-align: left;">Generate System Reports</a></li>
                    </ul>
                </div>
            <?php } ?>
        </div>
        ...
        <div style="text-align: center; padding: 10px;">
            ...
            <button onclick="toggleTheme()" style="padding: 5px 10px; cursor: pointer;">🌙 Toggle Theme</button>
        </div>
...
@task Feature 2: User Dashboard - Main Navigation and Quick Stats
@date 2026-01-15
============================================
-->
